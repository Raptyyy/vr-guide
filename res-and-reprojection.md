...
- **Oculus / Meta** headsets you can adjust it in the Oculus app (Settings > Graphics Preference > Render Resolution) Or in the [Oculus Debug Tool](https://youtu.be/ZO9A39eypbQ?si=wVWvHx8PkWSpVZUH) with the Pixels Per Display Pixel Override setting.  
...
- **Oculus / Meta** you can set it in the [Oculus Debug Tool](https://youtu.be/ZO9A39eypbQ?si=huKVdhTl7NkY1ewG&t=301) with the PC Asynchronous Spacewarp setting. (Debug tool can sometimes not honor the setting and ignore it).  
